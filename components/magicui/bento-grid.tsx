...
export default function BentoGrid() {
  ...
  return (
    <div
      className={cn(
        "relative text-white px-4 md:px-6 z-10 py-20",
        poppins.className,
      )}
    >
      <div className="w-full max-w-[95vw] lg:max-w-[1800px] mx-auto relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-12 grid-rows-6 gap-4 h-auto ">
          <motion.h1
            className={cn(
          ...
          >
            <span className="text-5xl text-white/80 leading-tight">
              Why Choose Our Digital Will dApp?
            </span>
            <br />
          ...
          <Link
            href="/"
            className="col-span-12 md:col-span-4 row-span-3 group cursor-pointer"
          >
            <motion.div
                ...
                <div className="flex-1 flex flex-col justify-center">
                  <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-4 mb-4 border border-white/10">
                    ...
                    <p className="text-green-300 text-sm">
                      Your wishes, executed instantly
                    </p>
                  </div>
                  <p className="text-white/70 text-sm font-light">
                    Our dApp leverages Aptos&apos;s parallel execution for
                    ultra-fast, reliable will fulfillment—so your loved ones
                    never wait.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <div className="relative z-10 h-full flex flex-col">
                <div className="mb-6">
                  ...
                  <p className="text-white/90 text-sm font-light">
                    Affordable for everyone, always
                  </p>
                </div>
          ...
          <Link
            href="/"
            className="col-span-12 md:col-span-4 row-span-2 group cursor-pointer"
          >
            <motion.div
              className="h-full bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 relative overflow-hidden hover:bg-white/10 transition-all duration-300 hover:-translate-y-1 shadow-xl"
              variants={cardVariants}
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h3 className="text-lg font-thin text-white">
                      Why Aptos, Not Ethereum or Solana?
                    </h3>
                    <p className="text-white/90 text-sm font-light">
                      Security, speed, and future-proofing
                    </p>
                  </div>
          ...
          <Link
            href="/"
            className="col-span-12 md:col-span-4 row-span-1 group cursor-pointer"
          >
            <motion.div
          ...
          <Link
            href="/"
            className="col-span-12 md:col-span-3 row-span-3 group cursor-pointer"
          >
            <motion.div
              className="h-full bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 relative overflow-hidden hover:bg-white/10 transition-all duration-300 hover:-translate-y-1 shadow-xl"
              variants={cardVariants}
            ...
            >
              ...
              <div className="relative z-10 h-full flex flex-col items-center justify-center text-center">
                ...
                <h3 className="text-xl font-thin mb-3 text-white">
                  Create Your Will
                </h3>
                <p className="text-white/70 text-sm leading-relaxed mb-6 font-light">
                  Set up your digital legacy in minutes. Our dApp automates will
                  creation and asset distribution, secured by Aptos.
                </p>
                <div className="mt-auto">
                  <ChevronRight
                    className="text-[#df500f] w-6 h-6"
                    strokeWidth={2}
                  />
                </div>
              </div>
          ...
          <Link
            href="/"
            className="col-span-12 md:col-span-5 row-span-3 group cursor-pointer"
          >
            <motion.div
              className="h-full bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 relative overflow-hidden hover:bg-white/10 transition-all duration-300 hover:-translate-y-1 shadow-xl"
              variants={cardVariants}
